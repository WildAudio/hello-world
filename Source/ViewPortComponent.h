...
{
public:
	ViewportComponent(AudioTransportSource &transportSourceToUse, AudioTransportSource &transportSourceToUse2, AudioTransportSource &transportSourceToUse3, AudioTransportSource &transportSourceToUse4, AudioTransportSource &timerToUse, File *filesToUse[4])
		...
		timer(timerToUse)
	{
		...
		trackContainer = new TrackContainer(transportSource, transportSource2, transportSource3, transportSource4, timer, files);
