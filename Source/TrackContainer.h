...
{
public:
	TrackContainer(AudioTransportSource &transportSourceToUse, AudioTransportSource &transportSourceToUse2, AudioTransportSource &transportSourceToUse3, AudioTransportSource &transportSourceToUse4, AudioTransportSource &timerToUse, File *filesToUse[4])
		...
		timer(timerToUse)
	{
		...
		editWindow = new EditWindow(transportSource, transportSource2, transportSource3, transportSource4, timer, files);
